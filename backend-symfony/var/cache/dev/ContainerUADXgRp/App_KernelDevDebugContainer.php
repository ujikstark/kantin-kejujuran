...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\CanteenController' => 'getCanteenControllerService',
            ...
            'App\\Controller\\UserBalanceController' => 'getUserBalanceControllerService',
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8Uv+3Ly9qE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDebug_Security_FirewallService()
    {
        ...
        $a->registerListener('main', 'app_logout', 'logout', '_csrf_token', NULL, NULL);
        ...
        }, 2)), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()), $a);
    }
